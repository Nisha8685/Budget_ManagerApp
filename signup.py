...
def signup(window):
    ...
    frame1=tkinter.Frame(signup_window)
    frame1.pack()
    ...
    firstnametxt = tkinter.Entry(frame1, bg='white')  # Set entry background color
    ...
    lastnametxt = tkinter.Entry(frame1, bg='white')  # Set entry background color
    ...
    user_idtxt = tkinter.Entry(frame1, bg='white')  # Set entry background color
